...
const translations: Record<string, Record<string, string>> = {
  zh: {
    ...
    "settings.online_catalog": "在线供应商目录",
    "settings.load_catalog": "加载更多供应商（Oh My Pi 目录）",
    "settings.catalog_loading": "加载中…",
    "settings.catalog_loaded": "已加载 {count} 家在线供应商，点上方「添加供应商」浏览",
  ...
  en: {
    ...
    "settings.online_catalog": "Online provider catalog",
    "settings.load_catalog": "Load more providers (Oh My Pi catalog)",
    "settings.catalog_loading": "Loading…",
    "settings.catalog_loaded": "Loaded {count} online providers — open \"Add provider\" above to browse",
