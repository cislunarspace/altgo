...
const translations: Record<string, Record<string, string>> = {
  zh: {
    ...
    "settings.engine_local": "本地 (SenseVoice)",
    ...
    "preset.mimo_asr": "小米 MiMo ASR",
    "preset.mimo_asr_desc": "小米多模态语音识别，支持中英文自动检测、方言、噪声环境",
    "preset.local_sensevoice": "本地 SenseVoice",
    "preset.local_sensevoice_desc": "本地运行，无需网络，速度快",
  ...
  en: {
    ...
    "settings.engine_local": "Local (SenseVoice)",
    ...
    "preset.mimo_asr": "Xiaomi MiMo ASR",
    "preset.mimo_asr_desc": "Multimodal speech recognition with auto language detection and noise resistance",
    "preset.local_sensevoice": "Local SenseVoice",
    "preset.local_sensevoice_desc": "Runs locally, no network required, fast",
