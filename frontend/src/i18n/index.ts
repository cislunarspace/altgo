...
const translations: Record<string, Record<string, string>> = {
  zh: {
    ...
    "preset.local_whisper": "本地 whisper.cpp",
    "preset.local_whisper_desc": "本地运行，无需网络，支持 GPU 加速",
  ...
  en: {
    ...
    "preset.local_whisper": "Local whisper.cpp",
    "preset.local_whisper_desc": "Runs locally, no network required, GPU acceleration supported",
