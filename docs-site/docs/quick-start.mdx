...
altgo 支持 Linux、macOS 和 Windows。选择你的平台：
...
:::info 辅助功能权限
altgo 使用 CGEvent tap 监听按键，需要在 **系统设置 → 隐私与安全性 → 辅助功能** 中授权终端或 altgo 应用。
:::
...
Linux / macOS 可使用 `sudo make install` 安装到系统路径。
